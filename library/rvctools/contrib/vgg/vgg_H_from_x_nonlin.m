...
% Modified by Peter Corke to work with standard Matlab optimizer fminsearch
...
if exist('lsqnonlin'),
    ...
    H_cond = fminsearch(@lsq_func2, H_cond, opt);
end
...
function r = lsq_func(H)
  ...
  % for fminsearch (standard Matlab optimizer) need a scalar cost
  function r = lsq_func2(H)
  global gp1 gp2 C1 C2;
